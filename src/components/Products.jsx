...
import about from "../assets/company_state/mobile.png";
import tesla from '../assets/company_state/tesla.png';
...
const Products = () => {
  return (
    <div className="px-4 lg:px-14 max-w-screend-2xl mx-auto my-8" id='product'>
      ...
      <div className="px-4 lg:px-14 max-w-screend-2xl mx-auto bg-neutralSilver py-16" id='testimonials'>
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="md:w-1/3">
            <img src={tesla}  className='h-[360px]'/>
          </div>
                ...
                <div>
                    <div className='flex items-center gap-8 flex-wrap'>
                        ...
                        <div  className='flex items-center gap-8'>
                                <a href='/' className='text-brandPrimary font-bold hover:text-neutral-700'>Meet all customers <svg 
