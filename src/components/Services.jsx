...
const Services = () => {
    ...
    const services = [
        { id:1, title:"Membership Organisations", description:"Our membership management software provides full automation of membership renewals and payments", image:(icon1)},
  ...
  return (
    ...
    <p className='text-neutralDGrey'>We have been working with some Fortune 500+ clients</p>
        ...
        {
            services.map(service => <div key={service.id} className=' px-4 py-8 text-center md:w-[300px] mx-auto md:h-80 rounded-md shadow cursor-pointer hover:-translate-y-5 hover:border-b-4 hover:border-indigo-700 tansition-all duration-300 flex items-center justify-center h-full'>
                
                <div>
                    <div className='bg-[#E8F5E9] h-14 w-14 mb-4 mx-auto rounded-tl-3xl rounded-br-3xl'> <img src={service.image} alt='' className='-ml-3'/></div>
